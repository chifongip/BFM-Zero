...
MODEL_PATH = "./249M_checkpoint/checkpoint/model"
...
SAMPLE_DATA_FILE = os.path.join(_THIS_FILE_DIR, "lafan_replay_sample_data.npz")
...
# Pick your reward function 

# stand still
# reward_function = MJWRotationReward()
# reward_function.target_ang_velocity = 0

# forward
# reward_function = MJWLocomotionReward()
# reward_function.move_speed = 0
# reward_function.move_angle = 0

reward_function = MJWMoveAndRotateReward()
reward_function.move_speed = 0.5
reward_function.target_ang_velocity = 0.2

# backward
# reward_function = MJWLocomotionReward()
# reward_function.move_speed = 0.7
# reward_function.move_angle = 180

# sidestep - left
# reward_function = MJWLocomotionReward()
# reward_function.move_speed = 0.7
# reward_function.move_angle = 90
...
# counterclockwise
# reward_function = MJWRotationReward()
# reward_function.target_ang_velocity = 5

# clockwise
# reward_function = MJWRotationReward()
# reward_function.target_ang_velocity = -5

# reward_function = MJWSitOnGroundReward()
